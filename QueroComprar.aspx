<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="QueroComprar.aspx.cs" Inherits="QueroComprar" %>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-lg-12">
                    <h1 class="h1"><i class="fa fa-male"></i>QUERO <small>COMPRAR</small></h1>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="col-md-12">
                        <div class="alert alert-default" role="alert">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <asp:DropDownList runat="server" CssClass="form-control" ID="ddlModelo"
                                        DataTextField="descricao" DataValueField="id" OnDataBound="ddlModelo_DataBound"
                                        Enabled="false" AutoPostBack="true"
                                        OnSelectedIndexChanged="ddlModelo_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </div>
                                <div class="col-md-4">
                                    <asp:Label AssociatedControlID="ddlFaixaPreco" Text="Faixa de preço"
                                        runat="server" />
                                    <asp:DropDownList runat="server" CssClass="form-control" ID="ddlFaixaPreco"
                                        AutoPostBack="true" OnSelectedIndexChanged="ddlFaixaPreco_SelectedIndexChanged">
                            ...
                            <div class="row">
                                <div class="col-md-4 col-lg-4 col-sm-12">
                                    ...
                                    <asp:TextBox ClientIDMode="Static" ID="txtAnoInicial" runat="server"
                                        CssClass="form-control" MaxLength="4" />
                                    <%--<h6>ex.: 20.000 até</h6>--%>
                                </div>
                                <div class="col-md-4 col-lg-4 col-sm-12">
                                    <asp:Label runat="server" AssociatedControlID="txtAnoAte">Ano até:</asp:Label>
                                    <asp:TextBox ClientIDMode="Static" ID="txtAnoAte" runat="server"
                                        CssClass="form-control" MaxLength="4" />
                                    <%--<h6>ex.: 60.000 até</h6>--%>
                                </div>
                                <div class="col-md-4 col-lg-4 col-sm-12">
                                    ...
                                    <asp:DropDownList ID="ddlTipo" runat="server" CssClass="form-control"
                                        DataSourceID="SQLDSTipos" DataTextField="descricao" DataValueField="id"
                                        OnDataBound="ddlTipo_DataBound">
                                    </asp:DropDownList>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <asp:LinkButton ID="lbBuscar" runat="server" OnClick="lbBuscar_Click"
                        ...
                        <div class="row">
                            <asp:ListView ID="lvVeiculos" runat="server" GroupItemCount="4"
                                OnPagePropertiesChanged="lvVeiculos_PagePropertiesChanged">
                                <EmptyDataTemplate>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="product-price-col">
                                                    <div class="price-container-desktop">
                                                        ...
                                                        <%--<div class="inventory-msrp-label">
                                                </div>--%>
                                                    </div>
                                                </div>
                                                ...
                                                <h4 class="label-col">Cor:
                                                    <b class="product-price-col">
                                                        <asp:Label ID="corLbl" runat="server"
                                                            Text='<%# Eval("cor") %>' />
                                                    </b>
                                                </h4>
                                            ...
                                            <asp:DataPager ID="DataPager2" runat="server" PageSize="24">
                                                <Fields>
                                                    ...
                                                    <asp:NextPreviousPagerField ButtonCssClass="btn btn-info"
                                                        ...
                                                        NextPageText="Próxima" PreviousPageText="Anterior" />
