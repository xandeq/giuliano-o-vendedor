<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ResultadoBusca.aspx.cs" Inherits="ResultadoBusca" %>
                    ...
                    <div class="col-md-12">
                            ...
                            <ContentTemplate>
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <asp:DropDownList runat="server" CssClass="form-control" ID="ddlModelo" DataTextField="descricao" DataValueField="id"
                        ...
                        <div class="col-md-12">
                            ...
                            <asp:DropDownList runat="server" CssClass="form-control" ID="ddlFaixaPreco">
                                <%-- AutoPostBack="true" 
                                    OnSelectedIndexChanged="ddlFaixaPreco_SelectedIndexChanged">--%>
